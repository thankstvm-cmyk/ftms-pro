...
#IMAGE ENHANCEMENT FUNCTIONS OF GRACESCAN
    ...
    @staticmethod
    def autodetect_and_crop(image_file):
        """ Detect the actual document in the scanned image 
        and crop it. Return the cropped image path."""
        ...
        #IGNORE TINY OBJECTS (DUST / NOISE)
        if w<100 or h < 100:
            return image_file
